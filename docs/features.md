...
> [!CAUTION]
> `time` パラメータは、2026年6月までは既にお持ちのアクセスキーでもご利用可能です。2026年7月以降は専用のアクセスキーでのみご利用可能とする予定です（続報は今後ご案内いたします）。
...
> [!CAUTION]
> ダイヤ探索の機能（`departure`, `arrival`, `lastTrain`, `firstTrain`）は2026年6月までは既にお持ちのアクセスキーでもご利用可能です。2026年7月以降は専用のアクセスキーでのみご利用可能とする予定です（続報は今後ご案内いたします）。
